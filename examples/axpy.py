# We import NumPy and Prickle. In this example, we store data in NumPy arrays.
import numpy as np
import prickle
...
# @prickle.jit to indicate that we want it to be parallelized; when we call
...
# keyword argument. We use the 'prickle.par' function to construct a default
...
# A Prickle function mutates its provided arguments, and it cannot allocate new
